...
import {
  ...
  UserPlus, Workflow, ClipboardList, Webhook, HeartPulse,
} from "lucide-react"
...
const navGroups = [
  {
    ...
    items: [
      ...
      { title: "Client Health", url: "/health",           icon: HeartPulse },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Integrations",     url: "/admin/integrations",  icon: Webhook },
